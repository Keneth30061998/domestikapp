...
Color color_primary = const Color.fromARGB(255, 20, 21, 49);
Color color_secondary = const Color.fromRGBO(9, 74, 139, 1.0);
Color color_text = const Color.fromRGBO(37, 139, 239, 1.0);
Color background_form = const Color.fromARGB(230, 255, 250, 250);
Color background_elevatedButton = const Color.fromARGB(255, 255, 255, 255);
